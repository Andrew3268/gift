...
class GuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post guides_url, params: { guide: { display_in_navbar: @guide.display_in_navbar, g_description: @guide.g_description, gname: @guide.gname } }
    end
  ...
  test "should update guide" do
    patch guide_url(@guide), params: { guide: { display_in_navbar: @guide.display_in_navbar, g_description: @guide.g_description, gname: @guide.gname } }
